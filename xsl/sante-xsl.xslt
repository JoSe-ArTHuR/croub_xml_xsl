...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="post-media wow fadeIn">
									<img src="images/croub/sante.jpg" alt="" class="img-responsive img-rounded"/>
								</div><!-- end media -->
							</div><!-- end col -->
			
						<div class="section-title text-center">
							
							<h3  style="color:red; text-align:justify;"><xsl:apply-templates select="croub/sante/label"/></h3>
							<p class="lead"><xsl:apply-templates select="croub/sante/organisation"/></p>
						</div><!-- end title -->
	...
	<xsl:template match="croub/sante">
	             <div>
	...
	<xsl:template match="croub/sante">
	            <div> <xsl:value-of select="organisation"/> </div>
	</xsl:template>
